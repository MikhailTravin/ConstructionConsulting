...
***************************************************************************** */
        ...
        function indents() {
            ...
            if (arrowNext && imagesSliderContainer && imagesSlider && imagesSwiper && imagesSwiperDesc.length > 0) {
                ...
                const sumMainHome = (wimagesSlider - wimagesSliderContainer) / 2;
                arrowPrev.style.left = `${sumMainHome}px`;
                arrowNext.style.right = `${sumMainHome}px`;
                arrowPrev.style.top = `calc(50% - ${himagesSwiperDesc / 2}px)`;
                arrowNext.style.top = `calc(50% - ${himagesSwiperDesc / 2}px)`;
            }
        }
