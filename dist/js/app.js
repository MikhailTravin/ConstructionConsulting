 ...
 */
    ...
    (() => {
        ...
        function tabs() {
            ...
            if (tabs.length > 0) {
                ...
                tabs.forEach(((tabsBlock, index) => {
                    ...
                    initTabs(tabsBlock);
                    initTabSlidesAndBottomBlocks(tabsBlock);
                }));
            ...
            function initTabSlidesAndBottomBlocks(tabsBlock) {
                const tabSlides = tabsBlock.querySelectorAll(".tabs__slide");
                const bottomTabsColumns = document.querySelectorAll(".bottom-tabs__column");
                function activateBottomTab(slideId) {
                    bottomTabsColumns.forEach((column => {
                ...
                tabSlides.forEach((slide => {
                    slide.addEventListener("click", (() => {
                        ...
                        const activeTabBody = slide.closest(".tabs__body");
                        if (activeTabBody) activeTabBody.querySelectorAll(".tabs__slide").forEach((s => s.classList.remove("_active")));
                        slide.classList.add("_active");
                        activateBottomTab(slideId);
                    }));
                }));
            }
                ...
                if (tabsContent.length > 0) {
                    ...
                    tabsContent.forEach(((tabsContentItem, index) => {
                        if (tabsTitles[index].classList.contains("_tab-active")) {
                            ...
                            const firstSlide = tabsContentItem.querySelector(".tabs__slide:first-child");
                            if (firstSlide) {
                                tabsContentItem.querySelectorAll(".tabs__slide").forEach((s => s.classList.remove("_active")));
        ...
        if (document.querySelector(".images-product")) {
            const thumbsSwiper = new core(".images-product__thumb", {
            ...
            if (tabsSliders.length > 0) tabsSliders.forEach((slider => {
                ...
                function initOrDestroySwiper() {
                    ...
                    if (windowWidth < 992) {
                        ...
                        if (isDocumentsSlider) Object.assign(config, {
                            slidesPerView: 8,
                            breakpoints: {
                                0: {
                                    slidesPerView: "auto"
...
***************************************************************************** */
        ...
        function indents() {
            ...
            if (bannerContent) bannerContent.style.paddingTop = `${hHeader}px`;
        ...
        if (inputContainer) {
            ...
            function toggleFilledClass() {
                if ("" !== input.value.trim()) inputContainer.classList.add("filled"); else inputContainer.classList.remove("filled");
            }
        ...
        function handleInput() {
            ...
            if (parent) parent.classList.toggle("filled", hasValue);
        }
